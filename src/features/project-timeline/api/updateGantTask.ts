...
const updateGanttChartTask = ({ ganttChartTaskData, userId, projectId, ganttTaskId }: Props): Promise<GanttChartTask> => {
...
export const useUpdatedGanttChartTask = () => {
    ...
    async function updateGanttChartTaskFn(ganttChartTaskData : UpdateGanttChartTaskDTO, projectId: string, ganttTaskId: string) {
        try {
            dispatch(clearError());
